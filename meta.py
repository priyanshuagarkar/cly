#  I was made by a group of <a href="https://huggingface.co/flax-community/t5-recipe-generation#team-members">NLP Engineers</a> to train my two prodigy recipe creators: <strong>Chef Scheherazade</strong> and <strong>Chef Giovanni</strong>. 
...
<a class="contributor comma" href="https://www.linkedin.com/in/anushree-salunke-b17224215/">Anushree Salunke</a>
<a class="contributor comma" href="https://www.linkedin.com/in/eisha-saini-001779232/">Eisha Saini</a>
<a class="contributor comma" href="https://www.linkedin.com/in/pooja-tumma/">Pooja Tumma</a>
<a class="contributor comma" href="https://www.linkedin.com/in/sanskruti-shinde-468ba3248/">Sanskruti Shinde</a>
</div>
"""
CHEF_INFO = """
<h2 class="font-title" style="font-family:Apricots; font-size:40px;">Welcome to CheffLy! </h2>
<p class="strong font-body">
<span class="d-block extra-info" style="font-size:18px;">(We are at your service with two of the best chefs in the world: Chef Scheherazade, 
...
<p>
Hello everyone 👋, I am <strong>Cheffly</strong>, 
